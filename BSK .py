...
# ページ設定
st.set_page_config(page_title="バスケ分析Pro V03.1", layout="centered")

# --- 0. CSS注入 (ヘッダー改行対応 & 文字サイズ極小化) ---
st.markdown("""
    <style>
    /* 記録入力のボタン並びを強制 */
