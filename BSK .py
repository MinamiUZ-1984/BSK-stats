...
# ページ設定
st.set_page_config(page_title="バスケ分析Pro - 安定版", layout="centered")
...
with tab_report:
    if st.session_state.history.empty:
        ...
        try:
            ...
            st.write("集計エラー: データの整合性を確認してください")
